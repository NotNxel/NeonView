// shows.js - final standalone data file for your project

export const showsDb = [
  // Your original shows (posters unchanged)
  {
    title: 'Dexter',
  ...
  // Replaced posters only for added/new movies and shows - lightweight TMDB posters
  {
    title: 'Batman Begins',
  ...
  {
    title: 'Iron Man 2',
    poster: 'https://image.tmdb.org/t/p/w342/q04EjmljLzuaXr3veU39as7yWtz.jpg',
    genre: 'Action, Adventure, Sci-Fi',
    director: 'Jon Favreau',
  ...
  {
    title: 'Prison Break',
    poster: 'https://image.tmdb.org/t/p/w342/jUvQWh4m2x0ijcyf5q8pVZgKtmS.jpg', // updated better poster
    genre: 'Action, Crime, Drama, Thriller',
  ...
  {
    title: 'Moon Knight',
    poster: 'https://image.tmdb.org/t/p/w342/7ZbzemjK5Z6QcgUi0mUL2jwPgaK.jpg', // better poster
  ...
  // Added new movies & series with lightweight posters
  {
    title: 'Interstellar',
  ...
  {
    title: 'Dunkirk',
    poster: 'https://image.tmdb.org/t/p/w342/ebSnODDg9lbsMIaWg2uAbjn7TO5.jpg',
  ...
  {
    title: 'Oppenheimer',
    poster: 'https://image.tmdb.org/t/p/w342/5fPFrq1J29WmgPbPF9e4V6Fm0v.jpg',
  ...
  },
  {
    ...
    poster: 'https://image.tmdb.org/t/p/w342/2b4ff7gJEZ3k48aAkaMh3XTMlyF.jpg',
    genre: 'Drama, Romance',
    director: 'Baz Luhrmann',
    actors: 'Leonardo DiCaprio, Tobey Maguire, Carey Mulligan',
    country: 'US',
    desc: 'A Midwesterner moves to Long Island and meets a mysterious millionaire.'
  },
  {
    title: 'Minority Report',
    poster: 'https://image.tmdb.org/t/p/w342/tc2tgEGVmLrlmrw2XoiAAx4ji9D.jpg',
    genre: 'Action, Crime, Sci-Fi, Thriller',
    director: 'Steven Spielberg',
    actors: 'Tom Cruise, Colin Farrell, Samantha Morton',
    country: 'US',
    desc: 'In the future, a specialized police department arrests criminals based on foreknowledge provided by psychics.'
  },
  {
    title: 'Mission: Impossible',
    poster: 'https://image.tmdb.org/t/p/w342/y58KqJHr7eGOXv6CR6XHJYFeYda.jpg',
    genre: 'Action, Adventure, Thriller',
    director: 'Brian De Palma',
    actors: 'Tom Cruise, Jon Voight, Emmanuelle Béart',
    country: 'US',
    desc: 'An American agent, under false suspicion of disloyalty, must discover and expose the real spy without the help of his organization.'
  },
  {
    title: 'Harry Potter and the Sorcerer\'s Stone',
    poster: 'https://image.tmdb.org/t/p/w342/cTkDxwA6Tm86E2W1EtEmFvRXkVM.jpg',
  ...
  },
  {
    ...
    poster: 'https://image.tmdb.org/t/p/w342/fYzpM9GmpBlIC893fNjoWCwE24H.jpg',
    genre: 'Crime, Thriller',
    director: 'Steven Soderbergh',
    actors: 'George Clooney, Brad Pitt, Matt Damon',
    country: 'US',
    desc: 'Danny Ocean and his eleven accomplices plan to rob three Las Vegas casinos simultaneously.'
  },
  {
    title: "Ocean's Twelve",
    poster: 'https://image.tmdb.org/t/p/w342/hOBA8WXOBhTnj0x6HUy8RtS9dRK.jpg',
    genre: 'Comedy, Crime, Thriller',
    director: 'Steven Soderbergh',
    actors: 'George Clooney, Brad Pitt, Matt Damon',
    country: 'US',
    desc: 'Danny Ocean and his crew come out of retirement to pull off three heists in Europe.'
  },
  {
    title: "Ocean's Thirteen",
    poster: 'https://image.tmdb.org/t/p/w342/h9Sn0q0IWl8JczVb22jp3koF7z6.jpg',
    genre: 'Comedy, Crime, Thriller',
    director: 'Steven Soderbergh',
    actors: 'George Clooney, Brad Pitt, Matt Damon',
    country: 'US',
    desc: 'Danny Ocean and his crew execute a plan to sabotage a casino.'
  },
  {
  ...
  },
  {
    ...
    country: 'US',
    desc: 'The presidencies of Kennedy and Johnson, the Vietnam War, and other history unfold through the perspective of an Alabama man.'
  },
  {
    title: 'Fight Club',
...
// script.js - sample usage to import and use showsDb data
...
doneBtn.onclick = () => {
  ...
  const topN = scores.filter(s => s.score > 0).slice(0
